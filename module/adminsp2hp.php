...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item active">Admin SP2HP</li>
            </ol>
        </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Admin SP2HP</h3>
              </div>
              <!-- /.card-header -->
              <?php
  ...
  if(isset($_POST['tambah_user'])){
    ...
    if($password2 != $password){
      ...
      if(mysqli_affected_rows($conn) > 0){
        ...
        window.location='index.php?module=adminsp2hp'</script>";
      }else{
       echo "<script>window.alert('Gagal menambahkan user')
        window.location='media.php?module=adminsp2hp'</script>";    
      }
    }
  }
        ...
        <div class="card-body register-card-body">
          ...
          <form action="" method="post">
            ...
            <div class="form-group">
              ...
              <?php
                $sql = mysqli_query($conn, "SELECT * FROM role where id = 2");
